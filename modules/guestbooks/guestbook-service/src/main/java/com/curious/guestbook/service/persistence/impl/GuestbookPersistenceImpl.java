...
import com.curious.guestbook.exception.NoSuchGuestbookException;
import com.curious.guestbook.model.Guestbook;
import com.curious.guestbook.model.impl.GuestbookImpl;
import com.curious.guestbook.model.impl.GuestbookModelImpl;
import com.curious.guestbook.service.persistence.GuestbookPersistence;
import com.curious.guestbook.service.persistence.GuestbookUtil;
...
public class GuestbookPersistenceImpl
	...
	private static final String _FILTER_SQL_SELECT_GUESTBOOK_WHERE =
		"SELECT DISTINCT {guestbook.*} FROM GBS_Guestbook guestbook WHERE ";

	private static final String
		_FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {GBS_Guestbook.*} FROM (SELECT DISTINCT guestbook.guestbookId FROM GBS_Guestbook guestbook WHERE ";

	private static final String
		_FILTER_SQL_SELECT_GUESTBOOK_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN GBS_Guestbook ON TEMP_TABLE.guestbookId = GBS_Guestbook.guestbookId";

	private static final String _FILTER_SQL_COUNT_GUESTBOOK_WHERE =
		"SELECT COUNT(DISTINCT guestbook.guestbookId) AS COUNT_VALUE FROM GBS_Guestbook guestbook WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "guestbook";

	private static final String _FILTER_ENTITY_TABLE = "GBS_Guestbook";

	private static final String _ORDER_BY_ENTITY_ALIAS = "guestbook.";

	private static final String _ORDER_BY_ENTITY_TABLE = "GBS_Guestbook.";
