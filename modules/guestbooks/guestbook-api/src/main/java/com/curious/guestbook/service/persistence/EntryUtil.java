...
package com.curious.guestbook.service.persistence;
...
public class EntryUtil {
	...
	public static Entry findByUuid_First(
		...
		throws com.curious.guestbook.exception.NoSuchEntryException {
	 ...
	 * @return the range of matching entries that the user has permission to view
	 */
	public static List<Entry> filterFindByG_S(
		long groupId, int status, int start, int end) {
	 ...
	 * @throws NoSuchEntryException if a entry with the primary key could not be found
	 */
	public static Entry[] filterFindByG_S_PrevAndNext(
			long entryId, long groupId, int status,
			OrderByComparator<Entry> orderByComparator)
		throws com.curious.guestbook.exception.NoSuchEntryException {
